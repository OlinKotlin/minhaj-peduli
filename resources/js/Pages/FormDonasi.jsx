                ...
                <div className="max-w-5xl mx-auto px-6 py-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            <h2 className="text-xl font-bold text-gray-700 border-b pb-2">Profil Donatur</h2>

                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Sapaan *</label>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Do'a & Harapan</label>
                                <textarea
                                    name="notes" rows="4"
                            ...
                            <div className="flex items-center">
                                <input
                                    id="hamba-allah" type="checkbox" name="isAnonymous"
                                    checked={formData.isAnonymous} onChange={handleInputChange}
                                    className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                                />
                                <label htmlFor="hamba-allah" className="ml-2 block text-sm text-gray-600">
                        ...
                        <div className="space-y-8">
                            <div>
                                <h2 className="text-lg font-bold text-gray-700 mb-4">Ringkasan Transaksi</h2>
                                <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 shadow-sm">
                                    <img src={program.img} alt={program.title} className="w-full h-32 object-cover rounded-lg mb-4" />
                                    <p className="text-green-600 font-bold mb-1">Donasi</p>
                                    <h3 className="text-md font-semibold text-gray-800 mb-4">{program.title}</h3>
                                    <div className="flex justify-between items-center border-t border-gray-300 pt-3">
                                        <span className="font-bold text-gray-700">Total Donasi</span>
                                        <span className="font-bold text-gray-900">{formatRupiah(nominal)}</span>
                                    </div>
                                </div>
                            </div>

                            <div>
                                <h2 className="text-lg font-bold text-gray-700 mb-4">Pilih Metode Pembayaran *</h2>
                                <div className="border border-gray-200 rounded-lg overflow-hidden">
                                    ...
                                    <div className="p-4 bg-white flex items-center gap-4">
                                        <input type="radio" name="payment" defaultChecked className="h-5 w-5 text-green-600 focus:ring-green-500 border-gray-300" />
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 mb-1">
                                                <div className="font-bold text-blue-900 italic text-lg">BTN</div>
                                                <div className="bg-[#facc15] text-[10px] px-1 font-bold text-blue-900">Syariah</div>
                                            </div>
                                            <p className="text-xs text-gray-500">An. Yayasan Minhajul Misbah Al Jadid</p>
                                        </div>
                                        <span className="font-bold text-gray-500 text-sm">BTN</span>
                                    </div>
                                </div>
                            </div>
