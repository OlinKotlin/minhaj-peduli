...
export default function Laporan({ auth }) {
    // Data Dummy
    const summary = {
        total_masuk: 450000000,
        total_keluar: 125000000,
        saldo_akhir: 325000000
    };

    const mutasi = [
        { id: 1, tanggal: "24 Des 2025", uraian: "Pembelian Semen 50 Sak", tipe: "keluar", nominal: 5500000 },
        { id: 2, tanggal: "23 Des 2025", uraian: "Hamba Allah - Wakaf Masjid", tipe: "masuk", nominal: 1000000 },
        { id: 3, tanggal: "20 Des 2025", uraian: "Wakaf Tunai (Bpk. Budi)", tipe: "masuk", nominal: 500000 },
        { id: 4, tanggal: "18 Des 2025", uraian: "Biaya Tukang Minggu ke-2", tipe: "keluar", nominal: 3000000 },
        { id: 5, tanggal: "15 Des 2025", uraian: "Donasi Hamba Allah", tipe: "masuk", nominal: 250000 },
    ];
                    ...
                    <div className="max-w-6xl mx-auto px-6 -mt-10 relative z-30 pb-20">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                            <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-gray-50">
                                ...
                                <span className="text-xs font-medium text-gray-400">5 Transaksi Terakhir</span>
                            </div>
                            ...
                            <div className="bg-gray-50 px-6 py-4 text-center">
                                <button className="text-emerald-600 text-sm font-semibold hover:underline">Lihat Laporan Lengkap &rarr;</button>
                            </div>
                        </div>
                    </div>
                </div>
